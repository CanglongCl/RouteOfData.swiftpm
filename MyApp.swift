...
private func insertRouteHealthExp(container: ModelContainer) {
    let route = Route(name: "Health Expectation", url: Bundle.main.url(forResource: "healthexp", withExtension: "csv")!, remark: "This dataset displays the life expectancy and health spending in countries across years. Click the starred nodes to see beautiful charts generated by Swift Chart. ")
    container.mainContext.insert(route)
